    ...
    public ResponseEntity<?> create(@RequestBody TipoServicio tipoServicio) {
        try {
            ...
            if(Boolean.parseBoolean(respuesta.get(0)) && (rolId.equals("1") || rolId.equals("2") || rolId.equals("3"))){
                ...
                response.add(tipoServicioService.create(tipoServicio));
    ...
    public ResponseEntity<?> createMasive(@RequestBody ArrayList<TipoServicio> tiposServicio) {
        try {
            ...
            if(Boolean.parseBoolean(respuesta.get(0)) && (rolId.equals("1") || rolId.equals("2") || rolId.equals("3"))){
                ArrayList<Object> response = new ArrayList<Object>();
                response.add( respuesta.get(1));
                response.add(tipoServicioService.createMasive(tiposServicio));
                return new ResponseEntity<>(response, HttpStatus.ACCEPTED);
    ...
    public ResponseEntity<?> getTiposServicios() {
        try {
            ...
            if(Boolean.parseBoolean(respuesta.get(0)) && (rolId.equals("1") || rolId.equals("2") || rolId.equals("3"))){
                ArrayList<Object> response = new ArrayList<Object>();
                response.add( respuesta.get(1));
                response.add(tipoServicioService.getTiposServicios());
                return new ResponseEntity<>(response, HttpStatus.ACCEPTED);
    ...
    public ResponseEntity<?> getAllByDisponible(@PathVariable("estado") String estado) {
        try {
            ...
            if(Boolean.parseBoolean(respuesta.get(0)) && (rolId.equals("1") || rolId.equals("2") || rolId.equals("3"))){
                ArrayList<Object> response = new ArrayList<Object>();
                response.add( respuesta.get(1));
                response.add(tipoServicioService.getTiposServiciosByDisponible(estado));
                return new ResponseEntity<>(response, HttpStatus.ACCEPTED);
    ...
    public ResponseEntity<?> getTipoServicioById(@PathVariable("id") long id) {
        try {
            ...
            if(Boolean.parseBoolean(respuesta.get(0)) && (rolId.equals("1") || rolId.equals("2") || rolId.equals("3"))){
                ArrayList<Object> response = new ArrayList<Object>();
                response.add( respuesta.get(1));
                response.add(tipoServicioService.getTipoServicioById(id));
                return new ResponseEntity<>(response, HttpStatus.ACCEPTED);
    ...
    public ResponseEntity<?> update(@RequestBody TipoServicio tipoServicio) {
        try {
            ...
            if(Boolean.parseBoolean(respuesta.get(0)) && (rolId.equals("1") || rolId.equals("2") || rolId.equals("3"))){
                ArrayList<Object> response = new ArrayList<Object>();
                response.add( respuesta.get(1));
                response.add(tipoServicioService.update(tipoServicio));
                return new ResponseEntity<>(response, HttpStatus.ACCEPTED);
